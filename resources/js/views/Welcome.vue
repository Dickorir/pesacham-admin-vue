                ...
                <div class="card bg-secondary">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="font-size-35">47,033</div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 mb-3 mb-xl-0">
                                ...
                                <div class="d-flex align-items-end">
                                    <h2 class="mb-0 line-height-30 font-size-30">$41,235</h2>
                                    <span class="text-success small ml-2 d-flex align-items-center">
                                    <span class="ti-arrow-up mr-2"></span>
                                    <span class="badge bg-success-bright text-success rounded d-inline-flex align-items-center">1.9%</span>
                                </span>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 mb-3 mb-xl-0">
                                ...
                                <div class="d-flex align-items-end">
                                    <h2 class="mb-0 line-height-30 font-size-30">$10,180</h2>
                                    <span class="text-danger small ml-2 d-flex align-items-center">
                                    <span class="ti-arrow-down mr-2"></span>
                                    <span class="badge bg-danger-bright text-danger rounded d-inline-flex align-items-center">1.9%</span>
                                </span>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 mb-3 mb-xl-0">
                                ...
                                <div class="d-flex align-items-end">
                                    <h2 class="mb-0 line-height-30 font-size-30">$1,180</h2>
                                    <span class="text-success small ml-2 d-flex align-items-center">
                                    <span class="ti-arrow-up mr-2"></span>
                                    <span class="badge bg-success-bright text-success rounded d-inline-flex align-items-center">2.2%</span>
                                </span>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6">
                                ...
                                <div class="d-flex align-items-end">
                                    <h2 class="mb-0 line-height-30 font-size-30">$780</h2>
                                    <span class="text-danger small ml-2 d-flex align-items-center">
                                    <span class="ti-arrow-down mr-2"></span>
                                    <span class="badge bg-danger-bright text-danger rounded d-inline-flex align-items-center">1.9%</span>
                                </span>
